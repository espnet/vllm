...
class CompletionOutput:
    ...
    Args:
        ...
        audio_output: Base64-encoded WAV audio generated by audio-output
            models (bagpiper/opuslm), set on the final output only.
    """
    ...
    audio_output: str | None = None  # base64 WAV audio (audio-output models)
